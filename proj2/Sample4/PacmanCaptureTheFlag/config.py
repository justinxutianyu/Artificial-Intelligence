...
Partners = ['Drew Schmitt','Nick McCoy','Lewis Li']

AgentArgs = {'first':'test', 'second':'defense', 'third':'test'}

NotifyList = ['dschmitt@stanford.edu','nsmccoy@stanford.edu', 'lewisli@stanford.edu']
