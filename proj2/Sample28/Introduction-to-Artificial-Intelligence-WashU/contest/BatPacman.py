...
def createTeam(firstIndex, secondIndex, isRed,
               first = 'danielAgent1', second = 'danielAgent1'):
  """
...
class CaptureAgent1(CaptureAgent):
  ...
  def getMazeDistanceDefense(self, p1, p2):
    ...
    try:
      ...
      print "There was an exception!", p1, p2
  ...
  def evaluate(self, gameState, action):
    ...
    # print "B", self.behavior
    # print "F", features
    # print "W", weights
    # print "R", features * weights
...
class danielAgent1(CaptureAgent1):
  ...
  def getWeights(self, gameState, action):
    if self.behavior == "attack":
      return {'successorScore': 100, 'distanceToFood': -1, 'distanceToTeammate': 0.6}
    if self.behavior == "defend":
      return {'numInvaders': -1000, 'onDefense': 100, 'invaderDistance': -10, 'stop': -100, 'reverse': -2, 'distanceToTeammate': 0.6}
    if self.behavior == "escape":
      return {'successorScore': 100, 'distanceToFood': -1, 'certainDeath': -1000, 'distanceToOpponent': 2, 'distanceToTeammate': 0.6,
