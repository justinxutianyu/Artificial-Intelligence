...
def readCommand( argv ):
  ...
  map = random.randint(1,MAX_DIFFERENT_MAZES)
  mapper='RANDOM'+str(map)
  parser.add_option('-l', '--layout', dest='layout',
                    ...
                    metavar='RANDOM', default=mapper)
  #default:LAYOUT_FILE and defaultCapture
  ...
  parser.add_option('--fps', default=25, dest='fps', type='int',
                    help=default('Frames per second, use this to slow down / speed up '
                    'the game speed'))
  ...
  if options.textgraphics:
    import textDisplay
    args['display'] = textDisplay.PacmanGraphics(speed=delay)
  elif options.quiet:
    import textDisplay
...
#     args['display'] = captureGraphicsDisplay.PacmanGraphics(options.red, options.blue, options.zoom, 0, capture=True)
    ...
    args['display'] = graphicsDisplay.PacmanGraphics(options.zoom, 0, capture=True, delay=delay)
