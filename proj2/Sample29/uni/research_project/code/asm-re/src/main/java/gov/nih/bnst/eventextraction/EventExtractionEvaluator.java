...
public class EventExtractionEvaluator {
	private static final Logger LOG =
        LoggerFactory.getLogger(EventExtractionEvaluator.class);
	...
	public EventExtractionEvaluator(
        String eventPredictionPath,
        String eventEvalPath,
		String goldPath
    ) {
	...
	public String getAggregateEvaluation() {
        ...
        try {
            ...
            //      Commenting out for now because intuitively the
            //      JVM should handle garbage collection.
            /*
            System.gc();
            System.gc();
            System.gc();
	...
	public static String evaluateSingle(File inputFile, String goldPath) {
        ...
        try     {
			...
			Process normProcess = Runtime
                .getRuntime()
                .exec(normCmdLine, null);
	...
	void writeEvalFiles() throws IOException, InterruptedException {
		try {
            //Check that we're working with a valid directory
            ...
            for (File inputFile : listOfFiles) {
                ...
                //Evaluate A2 file and write results to output
