...
public class EventExtraction {
    ...
    static {
		DEFAULT_THRESHOLDS.put("Gene_expression", 7); //7, 10
		DEFAULT_THRESHOLDS.put("Transcription", 5); //5, 7
		DEFAULT_THRESHOLDS.put("Protein_catabolism", 7); //10
		DEFAULT_THRESHOLDS.put("Phosphorylation", 10); //7, 10
		DEFAULT_THRESHOLDS.put("Localization", 10); //7, 10
        ...
        DEFAULT_THRESHOLDS.put("Default", 3);
	}
