...
import gov.nih.bnst.preprocessing.annotation.Anaphora;
import gov.nih.bnst.preprocessing.annotation.Coreference;
...
public class StanfordDepDocProducer implements DocumentProducer {
	/* adapted from gov.nih.bnst.preprocessing.combine.testing.CombineInfo and
	 * gov.nih.bnst.preprocessing.combine.training.CombineInfo
	 */
	...
	private class SDAnnDocImpl implements AnnotatedDocument {
        ...
        public SDAnnDocImpl(String id, String corpus, List<? extends AnnotatedSentence> list, Integer lastProtId) {
			this.id = id;
            this.corpus = corpus;
			this.annSents = list;
			this.lastProtId = lastProtId;
        ...
        public List<BnstTermAnnotation> getTermAnnotations() {
            List<BnstTermAnnotation> list = null;
            return list;
        }

        public List<BnstEventAnnotation> getEvtAnnotations() {
            List<BnstEventAnnotation> list = null;
            return list;
        }
