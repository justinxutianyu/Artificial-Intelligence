...
class PositionInferenceAgent(CaptureAgent):
    """A virtual agent class. Inherit this class to get position inference ability. It uses particle filtering algorithm."""
...
class StateEvaluationOffensiveAgent(ExpectimaxAgent):
