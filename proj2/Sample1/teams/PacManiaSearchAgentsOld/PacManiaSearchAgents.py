...
class PacManiaSearchAgents(AgentFactory):
    ...
    def choose(self, agentStr, index): 
        ...
        if agentStr == 'keys':
            ...
            print "didn't find thing for", agentStr
...
class MetriculatedSearchAgent(CaptureAgent):
    ...
    def registerInitialState(self, gameState):
        ...
        self.distancer = distanceCalculator.Distancer(gameState.data.layout)
        self.distancer.getMazeDistances()
        print "INITIALISED DISTANCE CALCULATORN"
    ...
    def chooseAction(self, gameState):
        ...
        #print self.index, "action", zip(actions, values)
    ...
    def evaluate(self, gameState, action):
        ...
        #    print k, " : ", metrics[k]
        #print "Metrics, weights", zip(metrics, weights)
        #print "Metrics * weights", metrics*weights
    ...
    def getMetrics(self, gameState, action):
        ...
        if isPacman:
            for ghost in theirGhosts:
                ...
                #print "does this even", ((nextX, nextY) == ghost.getPosition()), ((6.0, 6.0) == (6, 6))
                # Pacman has run into a ghost
                if (nextX, nextY) == ghost.getPosition():
                    print "timer", ghost.scaredTimer
                    if ghost.scaredTimer <= 0:
                        #print "Oh dear we're about to get eat"
                        metrics['collide-scary-ghosts'] += 1
                        metrics['collide-edible-ghosts'] = 0
                    else:
                        #print "Time to feast on ectoplasm"
