(define (problem pacman)
    (:domain pacman-ghost-not-moving)
    ...
    (:init  (connected A1 A2)
            ...
            ;;assumption: ghost does not move.
            ...
            ;;food to grab is at c3, d4
    
    ;;goal situation: be at b1, b2 or b3 and no more food is left for pacman to 
    ;;eat
    (:goal
        (and (or (pacman_at B1)
                 (pacman_at B2)
